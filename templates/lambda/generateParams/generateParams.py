...
def lambda_handler(event, context):
    ...
    try:
        ...
        config_file_map[path] = extend_configuration_file(config_file_map[path], find_artifact(artifacts, 'GenBuildParams'))

        output_artifact = generate_output_artifact(config_file_map)

        outputArtifactDetails = find_artifact(job_data['outputArtifacts'], 'ParamGen')
